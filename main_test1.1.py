...
- The dispatch_action, safe_call, and search helpers are left unchanged as requested.
"""
...
def query_llama_for_action(user_text, context=None, timeout=8):
    ...
    Fixes the JSON parsing error by accessing response['message']['content'].
    """
    try:
        # Strict system instruction
        system_message = (
            "You are Phantom AI. Return ONLY a JSON object and nothing else.\n"
            "Format: {\"action\":\"...\",\"args\":{},\"reply\":\"...\"}"
        )
        ...
        # আপনার স্ক্রিনশটের এরর ফিক্স: ডিরেক্ট অবজেক্ট না নিয়ে কন্টেন্ট নেওয়া হচ্ছে
        text = response['message']['content'].strip()
        
        # JSON পার্সিং (বাড়তি টেক্সট থাকলে তা ফিল্টার করবে)
        try:
        ...
        # fallback logic
        return {"action": "reply", "args": {}, "reply": "I'm having trouble connecting to my brain."}
